...
import { Camera, User, Lock, Loader2, UserIcon, Landmark } from 'lucide-react';
...
export const Profile = () => {
  ...
  React.useEffect(() => {
    async function fetchUser() {
      try {
        ...
        setUser(user);
        setProfilePicture(user.avatar || user.profilePicture || '../components/avatar.png');
  ...
  const handleUpdateBankDetails = (e: React.FormEvent) => {
    ...
    // TODO: API call to update bank details
    setTimeout(() => {
            ...
            <Card className="p-6">
              ...
              <form onSubmit={handleUpdateProfile}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  ...
                  <Input label="Username" defaultValue={User.username} required />
